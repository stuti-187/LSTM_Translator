...
/**
 * Created by Kanika on 5/5/17.
 */

public class tab_ocr extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        cameraView = (SurfaceView) getView().findViewById(R.id.surface_view);
        ...
        if (!textRecognizer.isOperational()) {
            Log.w("MainActivty", "Detector dependencies are not yet available");
